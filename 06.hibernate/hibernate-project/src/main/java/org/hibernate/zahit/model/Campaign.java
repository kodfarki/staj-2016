...
@NamedQueries({
        @NamedQuery(name = "findAll", query = "SELECT s FROM Campaign s"),
        @NamedQuery(name = "update", query = "UPDATE Campaign c SET c.campaignName=:campaignName,c.description=:description WHERE c.campaignID= :id")
})

...
COMMENT ON COLUMN CAMPAIGN.CAMPAIGN_OPTION IS '0 : schedule  1 : update';
COMMENT ON COLUMN CAMPAIGN.TYPE IS '0 : non-recurring  1 : recurring';
CREATE UNIQUE INDEX AK_CAMPAIGN ON CAMPAIGN (EXTERNAL_CAMPAIGN_ID);
